...
class ConsentService {
      ...
      ConsentInformation.instance.requestConsentInfoUpdate(
        ...
        () async {
          ...
          if (available) {
              ...
              (form) async {
                form.show((_) async {
                  _lastCanRequestAds =
                      await ConsentInformation.instance.canRequestAds();
                  print(
                    'ConsentService: After consent form - can request ads: $_lastCanRequestAds',
                  );
            ...
            print(
              'ConsentService: No consent form available, using non-personalized ads',
            );
  ...
  Future<bool> showPrivacyOptions() async {
    ...
    final params =
        (kDebugMode && _debugRegion != null && _debugRegion != DebugRegion.none)
  ...
  AdRequest buildAdRequest() {
    ...
    print(
      'ConsentService: Building ad request - nonPersonalized: $nonPersonalized',
    );
