...
class ProductLookupService {
  ...
  Future<ProductLookupResult> fetchByBarcode(String barcode) async {
    ...
    final res = await http.get(uri, headers: {'User-Agent': userAgent});
    ...
    return ProductLookupResult.found(
      Product(
        ...
        ingredientsAnalysisTags: _parseStringList(
...
class ProductLookupResult {
  ...
  factory ProductLookupResult.found(Product p) =>
      ProductLookupResult._(p, true);
  factory ProductLookupResult.notFound() =>
      const ProductLookupResult._(null, false);
}
