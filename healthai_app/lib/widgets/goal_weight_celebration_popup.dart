...
class GoalWeightCelebrationPopup extends StatefulWidget {
  ...
  @override
  State<GoalWeightCelebrationPopup> createState() =>
      _GoalWeightCelebrationPopupState();
}
...
class _GoalWeightCelebrationPopupState extends State<GoalWeightCelebrationPopup>
  ...
  Widget _buildNutritionRow(
    ...
    return Row(
      children: [
        Icon(icon, size: isSmallScreen ? 20 : 24, color: kPrimaryGreen),
        SizedBox(width: 12),
        Expanded(
          child: Text(
            label,
