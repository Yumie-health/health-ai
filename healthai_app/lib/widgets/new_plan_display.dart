...
class _NewPlanDisplayState extends State<NewPlanDisplay>
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop:
          () async =>
              widget.fromNutritionalPlan, // Allow back if from nutritional plan
      child: Scaffold(
        backgroundColor: Colors.white,
        appBar:
            widget.fromNutritionalPlan
                ? AppBar(
                  backgroundColor: Colors.white,
    ...
    try {
      ...
      if (user != null) {
        ...
        final updateData = {
          ...
          'goal':
              widget.planData['goal'] ??
              'Maintain body weight', // Save the fitness goal
          'nutritionalPlanType':
              widget.planData['goal']?.toLowerCase().replaceAll(' ', '_') ??
              'maintenance',
        ...
        if (widget.planData['targetWeight'] != null) {
          ...
          updateData['targetWeightKg'] =
              widget.planData['targetWeight']; // Save with both field names
          updateData['hasReachedGoal'] =
              false; // Reset goal achievement if new target set
        }
